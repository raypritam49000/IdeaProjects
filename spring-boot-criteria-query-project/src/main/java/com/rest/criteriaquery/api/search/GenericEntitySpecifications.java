...
import com.rest.criteriaquery.api.entities.AuditableBaseEntity;
...
/**
 * Class containing a number of methods used to get a search specification
 * based on anything extending a BaseEntity
 *
 * @see SearchBuilder
 * @see BaseEntity
 */
public class GenericEntitySpecifications {
    ...
    /**
     * Creates a {@link Specification} which tries to search for text like the text to
     * match
     *
     ...
     */
    public static <T>
    Specification<T> includesMatchText(String textToMatch, String... path) {
     ...
     */
    public static <T>
    Specification<T> includesMatchTextWithJoin(String textToMatch, String joinTb, String path) {
        if (textToMatch == null || textToMatch.equals("")) {
            return null;
        }
    ...
    /**
     * Creates a {@link Specification} which tries to search for text exactly equaling
     * the text to match
     *
     * @param textToMatch the target string the database entries are compared against
     * @param path        the entity field that is being compared. multiple inputs can
     *                    be used to specify an entity property in a linked entity
     * @param <T>         the type of object (extending {@link BaseEntity} that appears
     *                    in the search result
     ...
     */
    public static <T>
    Specification<T> exactMatchText(String textToMatch, String... path) {
        if (textToMatch == null || textToMatch.equals("")) {
            return null;
        }
     ...
     */
    public static <T>
    Specification<T> exactMatchText(Integer textToMatch, String... path) {
        if (textToMatch == null) {
            return null;
        }
        return (root, query, builder) -> builder.equal(getSubProperty(root, path), textToMatch);
     ...
     */
    public static <T>
    Specification<T> exactMatchText(Double textToMatch, String... path) {
        if (textToMatch == null) {
            return null;
        }
        return (root, query, builder) -> builder.equal(getSubProperty(root, path), textToMatch);
     ...
     */
    public static <T>
    Specification<T> exactMatchTextWithJoin(String textToMatch, String joinTb, String path) {
        if (textToMatch == null || textToMatch.equals("")) {
            return null;
        }
        return (root, query, builder) -> {
    ...
    /**
     * @param booleanToMatch the target boolean the database entries are compared against
     * @param path           the entity field that is being compared. multiple inputs can
     *                       be used to specify an entity property in a linked entity
     * @param <T>            the type of object (extending {@link BaseEntity} that appears
     ...
     */
    public static <T>
    Specification<T> isTrue(Boolean booleanToMatch, String... path) {
    ...
    public static <T>
    Specification<T> isFalse(Boolean booleanToMatch, String... path) {
        if (booleanToMatch == null) {
            return null;
        }
     ...
     */
    public static <T>
    Specification<T> isTrueWithJoin(Boolean booleanToMatch, String joinTb, String path) {
        if (booleanToMatch == null) {
            return null;
        }
        return (root, query, builder) -> {
     ...
     */
    public static <T, Y>
    Specification<T> matchObjectIn(Y object, String... path) {
        if (object == null) {
            return null;
        }
     ...
     */
    public static <T, Y>
    Specification<T> matchObjectsIn(List<Y> objects, String... path) {
     ...
     */
    public static <T, Y>
    Specification<T> matchObjectInWithJoin(Y object, String joinTb, String path) {
        if (object == null) {
            return null;
        }
        return (root, query, builder) -> {
     ...
     */
    public static <T, Y>
    Specification<T> matchObjectsInWithJoin(List<Y> objects, String joinTb, String path) {
        if (objects == null || objects.size() == 0) {
            return null;
        }
        return (root, query, builder) -> {
    ...
    public static <T, Y>
    Specification<T> exactMatchObjectsInWithJoin(Y textToMatch, String joinTb, String path) {
        if (textToMatch == null || textToMatch.equals("")) {
            return null;
        }
        return (root, query, builder) -> {
    ...
    //method to return filtered subEntities.
//    public static <T, Y>
//    Specification<T> exactMatchObjectsInWithJoin1(Y textToMatch, String joinTb, String path) {
//        if (textToMatch == null || textToMatch.equals("")) {
//            return null;
//        }
//        return (root, query, builder) -> {
//            Join<Object, Object> join =(Join<Object, Object>)root.fetch(joinTb);
//            return builder.equal(join.get(path), textToMatch);
//        };
//    }
    ...
    /**
     * Creates a {@link Specification} which tries to search for matching non
     ...
     */
    public static <T, Y>
    Specification<T> isNotNullOrEmpty(String... path) {
     ...
     */
    public static <T, Y>
    Specification<T> isNotNull(String... path) {
        return (root, query, builder) -> getSubProperty(root, path).isNotNull();
    }


    public static <T>
    Specification<T> isNotEqual(String textToMatch, String... path) {
        if (textToMatch == null || textToMatch.equals("")) {
            return null;
        }
    ...
    public static <T, Y>
    Specification<T> isNullOrExactMatchText(String textToMatch, String... path) {
    ...
    /**
     * Creates a {@link Specification} which tries to search for matching
     * null fields
     *
     * @param path the entity field that is being compared. multiple inputs can
     *             be used to specify an entity property in a linked entity
     ...
     */
    public static <T, Y>
    Specification<T> isNull(String... path) {
     ...
     */
    public static <T>
    Specification<T> isDateInRange(Date from, Date to, String path) {
        if (from == null && to == null) {
            return null;
        }

        return (root, query, builder) -> builder.and(
                builder.isNotNull(root.get(path)),
                builder.between(root.get(path), from, to));
    }

    public static <T>
    Specification<T> matchesRegexPattern(String pattern, String... path) {
        ...
        return (root, query, builder) -> builder.equal(
                builder.function("regexp", Integer.class, getSubProperty(root, path), builder.literal(pattern)),
                1);
    }

    public static <T>
    Specification<T> isDateInRange(DateRange range, String path) {
     ...
     * @return {@link Specification} which can be used for general text searches
     */
    public static <T, Y extends Comparable<Y>>
    Specification<T> compareField(ComparativeOperation operation, Y target, String... path) {
        if (target == null) {
            return null;
        }
    ...
    // TODO: Java Doc + rename to isNotDeleted... maybe combine to matchActiveStatus?
